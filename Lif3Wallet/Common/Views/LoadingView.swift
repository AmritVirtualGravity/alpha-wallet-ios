...
extension LoadingView {
    static func tokenSelectionLoadingView() -> LoadingView {
        ...
        loadingView.backgroundColor = ConfigurationLif3.Color.Semantic.defaultViewBackground
        loadingView.label.textColor = ConfigurationLif3.Color.Semantic.alternativeText
        loadingView.loadingIndicator.color =  ConfigurationLif3.Color.Semantic.alternativeText
