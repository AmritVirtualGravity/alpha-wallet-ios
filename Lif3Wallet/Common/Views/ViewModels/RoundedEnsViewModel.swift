...
//    var labelTextColor: UIColor = ConfigurationLif3.Color.Semantic.labelTextActive
    var labelTextColor: UIColor = .white
//    var backgroundColor: UIColor = ConfigurationLif3.Color.Semantic.roundButtonBackground
