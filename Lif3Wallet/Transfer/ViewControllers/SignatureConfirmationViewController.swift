...
class SignatureConfirmationViewController: UIViewController {
    ...
    private func configure(for viewModel: SignatureConfirmationViewModel) {
        ...
        button1.shrinkBorderColor = ConfigurationLif3.Color.Semantic.loadingIndicatorBorder
        ...
        button2.shrinkBorderColor = ConfigurationLif3.Color.Semantic.loadingIndicatorBorder
