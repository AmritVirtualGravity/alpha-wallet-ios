...
class ActivityIndicatorControl: UIControl {
    private let circularLoadingView: CircularLoadingIndicatorView = {
        ...
        control.lineColor = ConfigurationLif3.Color.Semantic.pass
        control.backgroundLineColor = ConfigurationLif3.Color.Semantic.loadingIndicatorBorder
        control.checkmarkColor = ConfigurationLif3.Color.Semantic.pass
...
class CircularLoadingIndicatorView: UIView {
    ...
    private lazy var fillLayer: CAShapeLayer = {
        ...
        layer.fillColor = ConfigurationLif3.Color.Semantic.backgroundClear.cgColor
