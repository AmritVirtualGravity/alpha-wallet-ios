...
class TransactionConfirmationRowInfoView: UIView {
    ...
    private let titleLabel: UILabel = {
        ...
        titleLabel.textColor = ConfigurationLif3.Color.Semantic.defaultSubtitleText
    ...
    private let subTitleLabel: UILabel = {
        ...
        subTitleLabel.textColor = ConfigurationLif3.Color.Semantic.defaultForegroundText
