...
struct WalletPupupItemViewModel {
    ...
    let icon: UIImage?
    var highlightedBackgroundColor: UIColor = ConfigurationLif3.Color.Semantic.defaultSubtitleText.withAlphaComponent(0.1)
        var normalBackgroundColor: UIColor = ConfigurationLif3.Color.Semantic.defaultViewBackground
